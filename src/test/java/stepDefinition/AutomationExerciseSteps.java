...
public class AutomationExerciseSteps  {
    ...
    public void verify_whether_user_is_on_automation_exercise_page() {
        ...
        Assert.assertEquals(AutomationExerciseHooks.driver.getTitle(),expectedTitle);
    ...
    public void user_enters_username_and_password_in_respective_field() {
        AutomationExerciseHooks.driver.findElement(By.name("email")).sendKeys("gireedharbirajdar1011@gmail.com");
        AutomationExerciseHooks.driver.findElement(By.name("password")).sendKeys("Gireedhar10#");

    }
    @Then("User clicks on Login button on login page")
    public void user_clicks_on_login_button_on_login_page() {
        AutomationExerciseHooks.driver.findElement(By.xpath("//button[text()='Login']")).click();
    ...
    public void user_verify_title_of_product_page() {
        AutomationExerciseHooks.driver.findElement(By.xpath("//a[text()=' Products']")).click();
    ...
    public void user_clicks_on_men_category() {
        AutomationExerciseHooks.driver.findElement(By.xpath("//a[@href=\"#Men\"]")).click();

    }
    @Then("Select Tshirts sub category")
    public void select_tshirts_sub_category(){
        AutomationExerciseHooks.driver.findElement(By.xpath("//a[text()='Tshirts ']")).click();
    }
